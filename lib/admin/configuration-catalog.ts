...
export const configurationCatalog: ConfigurationCatalogCategory[] = [
  {
    ...
    entries: [
      ...
      { name: '公开战报角色评价总结', key: 'public_battle_summary_*', defaultValue: '启用 / 1440 分钟 / 系统默认模型', effect: '按周期总结最近 50 篇非日常公开战报并生成角色评价；分数和等级由服务端固定公式计算。', management: 'admin' },
  ...
  },
  {
    ...
    entries: [
      ...
      { name: '自定义屏蔽词', key: 'shield_word_rules_v1', defaultValue: '仅内置规则', effect: '在不删除内置安全基线的前提下，追加遮罩或指定替换规则。', management: 'admin' },
